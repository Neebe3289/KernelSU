...
import me.weishu.kernelsu.ui.component.ExpressiveLazyColumn
        ...
        if (isLoading) {
            ...
            Box(Modifier.padding(innerPadding)) {
                ExpressiveLazyColumn(
                    ...
                    contentPadding =
                        PaddingValues(start = 16.dp, top = 8.dp, end = 16.dp, bottom = 16.dp + 56.dp + 16.dp  /* Scaffold Fab Spacing + Fab container height */),
                    items = templateList,
